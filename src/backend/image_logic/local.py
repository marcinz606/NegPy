...
def calculate_luma_mask(img: np.ndarray, luma_range: Tuple[float, float], softness: float) -> np.ndarray:
    """
...
def apply_local_adjustments(img: np.ndarray, adjustments: List[Dict[str, Any]], scale_factor: float) -> np.ndarray:
    """
