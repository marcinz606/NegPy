...
def render_adjustments(current_file_hash: str) -> SidebarData:
    """
    ...
    render_presets(current_file_hash)

    # 1. Exposure & Tonality
    render_exposure_section()

    # 2. Color & Balance (includes Selective Color)
    render_color_section(current_file_hash)
    ...
    # 4. Retouch & Export
    retouch_data = render_retouch_section(current_file_hash)
