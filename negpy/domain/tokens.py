...
def composite_token(kind: str, config: Any, paths: Sequence[str]) -> str:
    ...
    for path in paths:
        ...
        try:
            ...
            return ""
        # Size and nanosecond mtime, not getmtime(): whole seconds miss a file rewritten
        # within the same second as the last decode, which is ordinary when a companion
        # exposure is regenerated by a script.
