...
handful of Calibration/Demosaic/Normalization facts that describe the rig and the
...
ROLL_DEFAULT_FIELDS: Dict[str, tuple] = {
    ...
    "process": ("e6_normalize", "analysis_buffer", "luma_range_clip", "color_range_clip"),
}
