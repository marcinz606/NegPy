...
class FinishConfig:
    ...
    carrier_enabled: bool = False  # filed-out negative carrier (black rebate frame)
    carrier_width: float = 2.0  # [0.5, 5.0] mm on the print
    carrier_rough: float = 0.5  # [0.0, 1.0] inner-edge jitter
    diffusion_amount: float = 0.0  # [0.0, 1.0] enlarger diffusion (blacks bloom into highlights)
    ...
    border_corner_style: str = "square"  # square | rounded | deckle
    keyline_width: float = 0.0  # [0.0, 2.0] mm, 0 = off
