...
class ThemeConfig:
    ...
    # roll (built from a search or hand-picked set, no folder behind it) shares
    # channel_red_text's coral -- vivid rather than accent_primary/error's darker,
    # more saturated reds, which both carry their own meaning already.
    roll_virtual: str = "#FF5A5A"
