...
class ShortcutManager:
    ...
    def _build_actions(self) -> dict[str, Callable[[], None]]:
        ...
        slider_targets: dict[str, Callable[[], object]] = {
            ...
            "density_saturation_damping_inc": lambda: controls.tone_sidebar.dye_mute_slider,
            "density_saturation_damping_dec": lambda: controls.tone_sidebar.dye_mute_slider,
