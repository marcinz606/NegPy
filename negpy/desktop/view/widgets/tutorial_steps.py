    ...
    return [
        ...
        TutorialStep(
            ...
            body=(
                ...
                "<b>Print Saturation</b> pushes the print's three dye densities apart in the "
                "same matrix the paper's own dye crosstalk uses — a darkroom operation, not a "
                "post-hoc colour boost, so it stays in step with the curve and takes per-layer "
                "R/G/B trims for crossover. <b>Dye Separation</b> then works per pixel: positive "
                "acts on the pixels whose dyes sit close together, negative on the ones already "
                "far apart. Ships off.<br><br>"
        ...
        TutorialStep(
            ...
            body=(
                ...
                "counterpart to <b>Print Saturation</b> over in Tone, which works on the print's dye "
                "densities instead. "
