...
class MetadataSidebar(BaseSidebar):
    ...
    def _init_ui(self) -> None:
        ...
        self.place_map_btn = QPushButton("Map…")
        self.place_map_btn.setToolTip("Pick the capture place on a map (contacts OpenStreetMap)")
        place_row.addWidget(self.place_map_btn)
        self.place_clear_btn = QPushButton("Clear")
