...
class GeometrySidebar(BaseSidebar):
    ...
    def _init_ui(self) -> None:
        ...
        self.auto_crop_all_btn.setIcon(qta.icon("fa5s.layer-group", color=THEME.text_primary))
        self.auto_crop_all_btn.setToolTip(
            "Analyze all visible frames together, keep existing manual crops, "
            "and save confident results before Batch Analysis (Image only mode)"
        )
    ...
    def _connect_signals(self) -> None:
        ...
        self.auto_crop_all_btn.clicked.connect(self.controller.apply_auto_crop_all)
