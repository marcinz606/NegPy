...
REGISTRY: dict[str, ShortcutEntry] = {
    ...
    "toggle_lith": ShortcutEntry("", "Lith printing on/off", "Lith"),
    "lith_snatch_dec": ShortcutEntry("", "Snatch point earlier", "Lith"),
    "lith_snatch_inc": ShortcutEntry("", "Snatch point later", "Lith"),
    "lith_exposure_dec": ShortcutEntry("", "Lith exposure down", "Lith"),
    "lith_exposure_inc": ShortcutEntry("", "Lith exposure up", "Lith"),
    "lith_abruptness_dec": ShortcutEntry("", "Lith abruptness down", "Lith"),
    "lith_abruptness_inc": ShortcutEntry("", "Lith abruptness up", "Lith"),
