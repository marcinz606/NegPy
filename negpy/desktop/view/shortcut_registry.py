...
REGISTRY: dict[str, ShortcutEntry] = {
    ...
    "converge_v_dec": ShortcutEntry("", "Converging verticals down", "Geometry"),
    "converge_v_inc": ShortcutEntry("", "Converging verticals up", "Geometry"),
    "converge_h_dec": ShortcutEntry("", "Converging horizontals down", "Geometry"),
    "converge_h_inc": ShortcutEntry("", "Converging horizontals up", "Geometry"),
