...
REGISTRY: dict[str, ShortcutEntry] = {
    ...
    "toggle_burn_map": ShortcutEntry("Shift+P", "Printer's burn map (stops + instructions)", "Tools"),
    ...
    "density_saturation_dec": ShortcutEntry("", "Print saturation down", "Exposure"),
    "density_saturation_inc": ShortcutEntry("", "Print saturation up", "Exposure"),
    "density_saturation_damping_dec": ShortcutEntry("", "Dye Mute down", "Exposure"),
    "density_saturation_damping_inc": ShortcutEntry("", "Dye Mute up", "Exposure"),
