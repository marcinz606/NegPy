...
SLIDER_GROUPS: tuple[SliderShortcutGroup, ...] = (
    ...
    _g("lith_exposure", "Lith exposure ↑/↓", "lith_exposure_inc", "lith_exposure_dec", 0.1, "Lith"),
    _g("lith_snatch", "Snatch point ↑/↓", "lith_snatch_inc", "lith_snatch_dec", 0.01, "Lith"),
    _g("lith_abruptness", "Lith abruptness ↑/↓", "lith_abruptness_inc", "lith_abruptness_dec", 0.01, "Lith"),
