...
def test_calculate_balancing_gammas():
    ...
    # Blue P90 = 0.8
    img = np.zeros((10, 1, 3))
    img[9, 0, 0] = 0.25 # Simplify percentile by just using one high value in a small array
    img[9, 0, 1] = 0.5
    img[9, 0, 2] = 0.8
    ...
    gammas = calculate_balancing_gammas(img, 100) # Use 100th percentile for our dummy image
