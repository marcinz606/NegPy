...
*   **Scanner Support**: Direct control of SANE-compatible scanners. The Nikon LS-5000 roll workflow adds a full-roll contact sheet, adjustable film spacing, RGB 4x plus IR for C-41, and RGB-only 4x capture for silver B&W. An optional [Portable Digital ICE integration](docs/PORTABLE_DIGITAL_ICE.md) adds the strict dual-RGBI acquisition and CPU/CUDA processing boundary. [LS-5000 roll scanning guide](docs/LS5000_ROLL_SCANNING.md) · [supported devices](http://www.sane-project.org/sane-supported-devices.html)
