...
- Change: **Lab Saturation renamed Chroma** — Chroma Denoise moves alongside it in the Colour row.
- Change: **Crosstalk's Separation slider renamed Strength** — the pair under CROSSTALK now reads Matrix / Strength, and "separation" means only the print-side Dye Separation.
