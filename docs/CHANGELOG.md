...
- **Reworked negative conversion** — the default conversion now behaves much more like a real darkroom print: paper-like highlight roll-off, true deep blacks, and a paper-white base. Out-of-the-box results should look more natural and photographic, and respond more predictably as you adjust Density and Grade.
...
- **The auto helpers are toggles you can switch off** — Auto Density and Auto Grade sit next to the Density and Grade sliders; Pick WB, Linear RAW, Contrast Lift and Cast Removal are grouped above them, and Flare and Paper White sit by the Toe and Shoulder sliders. They're on/off by default as noted and carried over to new files, but change them any time.
