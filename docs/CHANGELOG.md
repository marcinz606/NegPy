...
- **The auto helpers are toggles you can switch off** — small icon buttons next to the Density and Grade sliders (Shadow Neutral and Paper White sit by the Toe and Shoulder sliders). They're on by default and carried over to new files, but turn them off any time.
