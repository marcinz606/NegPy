...
*   **Swing** (±15%): the same movement about a vertical axis, straightening converging horizontals — a wall shot from one side, or a copy stand that is not square to the film. Positive stretches the left edge.
