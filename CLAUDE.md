...
- **Working-space OETF + luminance row are inlined** in `lab_sharpen_h.wgsl` (Adobe RGB 1998 gamma 563/256, D65 Y row) — a TRC or primaries change must update it, not just `kernel/image/logic.py`.
